...
module.exports = async (req, res) => {
  ...
  // PDF generation embeds invoice data (practice names, amounts, addresses)
  // — sensitive enough that we require a signed-in user. The PDF is
  // returned as base64 so anyone calling this endpoint could pull whatever
  // invoice payload they could fabricate; auth keeps the surface tight.
