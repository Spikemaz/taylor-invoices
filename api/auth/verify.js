...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    if (!user.sheetId) {
      console.error('[verify] User has no sheetId — onboarding incomplete?', user.userId, user.email);
      return redirectWithError(res, 'Account setup incomplete. Please contact support.');
    }
