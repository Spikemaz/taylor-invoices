...
// The correct column definitions (must match sheets-sync.js)
...
// AllEntries = userId + ENTRY_COLUMNS (21 columns total)
const ALL_ENTRIES_COLUMNS = ['userId', ...ENTRY_COLUMNS];
// AllInvoices = userId + INVOICE_COLUMNS (30 columns total)
const ALL_INVOICES_COLUMNS = ['userId', ...INVOICE_COLUMNS];
// DeletedEntries = simple structure for deleted entry records
